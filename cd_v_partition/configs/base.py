...
ExecutorKind = t.Literal["parsl", "process", "thread"]
...
class SimulationConfig:
    # Parameters only used to initialize the executor used to launch jobs across
    # compute.
    executor_kind: ExecutorKind = MISSING
    executor_args: dict[str, t.Any] = MISSING
    graph_per_spec: int = 1
    # eval_algorithms: list[str] = MISSING # These are the partitioning functions, all
    #   need to be run for each spec
    ...
    def __iter__(self) -> t.Iterator[SimulationSpec]:
        """
