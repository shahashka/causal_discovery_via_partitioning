...
if __name__ == "__main__":
    ...
    # func_partial = functools.partial(run_nnodes_alg, experiment_dir="./simulations/experiment_5_test/", nthreads=16, num_repeats=1, nnodes_range=[10**i for i in np.arange(1,4)], screen=True )
